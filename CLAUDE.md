...
3. An interactive **web demo** (`web/`) — the "Lorem & Ipsum" editorial app,
   built with **React + Vite**. React is a dev-only dependency of the demo; the
   published library stays zero-dependency.
